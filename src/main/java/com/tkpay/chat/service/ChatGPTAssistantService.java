package com.tkpay.chat.service;

import com.google.gson.Gson;
import com.tkpay.chat.dto.*;
...
public class ChatGPTAssistantService {
    ...
    public Map<String, Object> sendMessageToThread(String message, String assistantId, String threadId) {
        ...
        log.info("sendMessageToThread started. message: {} assistantId: {} threadId: {}", message, assistantId,
                threadId);
        ...
        try {
            ...
            try (CloseableHttpClient httpClient = HttpClients.custom().build();
                ...
                // ChatGPTCreateThreadResponse chatGPTCreateThreadResponse =
                // gson.fromJson(responseBody, ChatGPTCreateThreadResponse.class);
                //
                // log.info("sendMessageToThread got a response: {}",
                // chatGPTCreateThreadResponse);
                // log.info("sendMessageToThread got id: {}",
                // chatGPTCreateThreadResponse.getId());
                //
                // Map<String, Object> map = new HashMap<>();
                //
                // map.put("status", "Success");
    ...
    private Map<String, Object> getLastAssistantMessage(String threadId) {
